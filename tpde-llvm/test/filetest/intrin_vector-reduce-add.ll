...
define i8 @vr_add_v1i8(ptr %p) {
; X64-LABEL: <vr_add_v1i8>:
; X64:         movzx eax, byte ptr [rdi]
; X64-NEXT:    mov ecx, eax
; X64-NEXT:    mov eax, ecx
; X64-NEXT:    ret
;
; ARM64-LABEL: <vr_add_v1i8>:
; ARM64:         ldrb w1, [x0]
; ARM64-NEXT:    mov w2, w1
; ARM64-NEXT:    mov w0, w2
; ARM64-NEXT:    ret
  %v = load <1 x i8>, ptr %p
  %r = call i8 @llvm.vector.reduce.add(<1 x i8> %v)
  ret i8 %r
}

define i8 @vr_add_v5i8(ptr %p) {
; X64-LABEL: <vr_add_v5i8>:
; X64:         movzx eax, byte ptr [rdi]
...
; X64-NEXT:    lea r9d, [r9 + r10]
; X64-NEXT:    mov r11d, edx
; X64-NEXT:    lea r9d, [r9 + r11]
; X64-NEXT:    mov edi, esi
; X64-NEXT:    lea r9d, [r9 + rdi]
; X64-NEXT:    mov r10d, r8d
; X64-NEXT:    lea r9d, [r9 + r10]
; X64-NEXT:    mov eax, r9d
; X64-NEXT:    ret
;
; ARM64-LABEL: <vr_add_v5i8>:
; ARM64:         ldrb w1, [x0]
...
; ARM64-NEXT:    add w7, w7, w6
; ARM64-NEXT:    mov w8, w3
; ARM64-NEXT:    add w8, w8, w7
; ARM64-NEXT:    mov w9, w4
; ARM64-NEXT:    add w9, w9, w8
; ARM64-NEXT:    mov w10, w5
; ARM64-NEXT:    add w10, w10, w9
; ARM64-NEXT:    mov w0, w10
; ARM64-NEXT:    ret
  %v = load <5 x i8>, ptr %p
  %r = call i8 @llvm.vector.reduce.add(<5 x i8> %v)
  ret i8 %r
}

define i8 @vr_add_v8i8(ptr %p) {
; X64-LABEL: <vr_add_v8i8>:
; X64:         push rbp
...
; ARM64-NEXT:    add w4, w4, w3
; ARM64-NEXT:    umov w5, v0.b[5]
; ARM64-NEXT:    add w5, w5, w4
; ARM64-NEXT:    umov w6, v0.b[6]
; ARM64-NEXT:    add w6, w6, w5
; ARM64-NEXT:    umov w7, v0.b[7]
; ARM64-NEXT:    add w7, w7, w6
; ARM64-NEXT:    mov w0, w7
; ARM64-NEXT:    ret
  %v = load <8 x i8>, ptr %p
  %r = call i8 @llvm.vector.reduce.add(<8 x i8> %v)
  ret i8 %r
}

define i8 @vr_add_v16i8(ptr %p) {
; X64-LABEL: <vr_add_v16i8>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
...
; ARM64-NEXT:    add w11, w11, w10
; ARM64-NEXT:    umov w12, v0.b[12]
; ARM64-NEXT:    add w12, w12, w11
; ARM64-NEXT:    umov w13, v0.b[13]
; ARM64-NEXT:    add w13, w13, w12
; ARM64-NEXT:    umov w14, v0.b[14]
; ARM64-NEXT:    add w14, w14, w13
; ARM64-NEXT:    umov w15, v0.b[15]
; ARM64-NEXT:    add w15, w15, w14
; ARM64-NEXT:    mov w0, w15
; ARM64-NEXT:    ret
  %v = load <16 x i8>, ptr %p
  %r = call i8 @llvm.vector.reduce.add(<16 x i8> %v)
  ret i8 %r
}

define i8 @vr_add_v32i8(ptr %p) {
; X64-LABEL: <vr_add_v32i8>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    movups xmm0, xmmword ptr [rdi]
...
; ARM64-NEXT:    add w18, w18, w15
; ARM64-NEXT:    umov w30, v1.b[1]
; ARM64-NEXT:    add w30, w30, w18
; ARM64-NEXT:    umov w0, v1.b[2]
; ARM64-NEXT:    add w0, w0, w30
...
; ARM64-NEXT:    ret
  ...
  %r = call i8 @llvm.vector.reduce.add(<32 x i8> %v)
  ret i8 %r
}

define i16 @vr_add_v1i16(ptr %p) {
; X64-LABEL: <vr_add_v1i16>:
; X64:         movzx eax, word ptr [rdi]
; X64-NEXT:    mov ecx, eax
; X64-NEXT:    mov eax, ecx
; X64-NEXT:    ret
;
; ARM64-LABEL: <vr_add_v1i16>:
; ARM64:         ldrh w1, [x0]
; ARM64-NEXT:    mov w2, w1
; ARM64-NEXT:    mov w0, w2
; ARM64-NEXT:    ret
  %v = load <1 x i16>, ptr %p
  %r = call i16 @llvm.vector.reduce.add(<1 x i16> %v)
  ret i16 %r
}

define i16 @vr_add_v5i16(ptr %p) {
; X64-LABEL: <vr_add_v5i16>:
; X64:         movzx eax, word ptr [rdi]
...
; ARM64-NEXT:    ret
  ...
  %r = call i16 @llvm.vector.reduce.add(<5 x i16> %v)
  ret i16 %r
}

define i16 @vr_add_v8i16(ptr %p) {
; X64-LABEL: <vr_add_v8i16>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    movups xmm0, xmmword ptr [rdi]
; X64-NEXT:    movapd xmmword ptr [rbp - 0x40], xmm0
...
; ARM64-NEXT:    ret
  ...
  %r = call i16 @llvm.vector.reduce.add(<8 x i16> %v)
  ret i16 %r
}

define i16 @vr_add_v16i16(ptr %p) {
; X64-LABEL: <vr_add_v16i16>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    movups xmm0, xmmword ptr [rdi]
; X64-NEXT:    movups xmm1, xmmword ptr [rdi + 0x10]
...
; ARM64-NEXT:    ret
  ...
  %r = call i16 @llvm.vector.reduce.add(<16 x i16> %v)
  ret i16 %r
}

define i32 @vr_add_v1i32(ptr %p) {
; X64-LABEL: <vr_add_v1i32>:
; X64:         mov eax, dword ptr [rdi]
; X64-NEXT:    mov ecx, eax
; X64-NEXT:    mov eax, ecx
; X64-NEXT:    ret
;
; ARM64-LABEL: <vr_add_v1i32>:
; ARM64:         ldr w1, [x0]
; ARM64-NEXT:    mov w2, w1
; ARM64-NEXT:    mov w0, w2
; ARM64-NEXT:    ret
  %v = load <1 x i32>, ptr %p
  %r = call i32 @llvm.vector.reduce.add(<1 x i32> %v)
  ret i32 %r
}

define i32 @vr_add_v4i32(ptr %p) {
; X64-LABEL: <vr_add_v4i32>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    movups xmm0, xmmword ptr [rdi]
; X64-NEXT:    movapd xmmword ptr [rbp - 0x40], xmm0
...
; ARM64-NEXT:    ret
  ...
  %r = call i32 @llvm.vector.reduce.add(<4 x i32> %v)
  ret i32 %r
}

define i32 @vr_add_v5i32(ptr %p) {
; X64-LABEL: <vr_add_v5i32>:
; X64:         mov eax, dword ptr [rdi]
...
; ARM64-NEXT:    ret
  ...
  %r = call i32 @llvm.vector.reduce.add(<5 x i32> %v)
  ret i32 %r
}

define i32 @vr_add_v8i32(ptr %p) {
; X64-LABEL: <vr_add_v8i32>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    movups xmm0, xmmword ptr [rdi]
; X64-NEXT:    movups xmm1, xmmword ptr [rdi + 0x10]
...
; ARM64-NEXT:    ret
  ...
  %r = call i32 @llvm.vector.reduce.add(<8 x i32> %v)
  ret i32 %r
}

define i64 @vr_add_v1i64(ptr %p) {
; X64-LABEL: <vr_add_v1i64>:
; X64:         mov rax, qword ptr [rdi]
; X64-NEXT:    mov rcx, rax
; X64-NEXT:    mov rax, rcx
; X64-NEXT:    ret
;
; ARM64-LABEL: <vr_add_v1i64>:
; ARM64:         ldr x1, [x0]
; ARM64-NEXT:    mov x2, x1
; ARM64-NEXT:    mov x0, x2
; ARM64-NEXT:    ret
  %v = load <1 x i64>, ptr %p
  %r = call i64 @llvm.vector.reduce.add(<1 x i64> %v)
  ret i64 %r
}

define i64 @vr_add_v2i64(ptr %p) {
; X64-LABEL: <vr_add_v2i64>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    movups xmm0, xmmword ptr [rdi]
; X64-NEXT:    movapd xmmword ptr [rbp - 0x40], xmm0
...
; ARM64-NEXT:    ret
  ...
  %r = call i64 @llvm.vector.reduce.add(<2 x i64> %v)
  ret i64 %r
}

define i64 @vr_add_v5i64(ptr %p) {
; X64-LABEL: <vr_add_v5i64>:
; X64:         mov rax, qword ptr [rdi]
...
; X64-NEXT:    lea r9, [r9 + r10]
; X64-NEXT:    mov r11, rdx
; X64-NEXT:    lea r9, [r9 + r11]
; X64-NEXT:    mov rdi, rsi
; X64-NEXT:    lea r9, [r9 + rdi]
; X64-NEXT:    mov r10, r8
; X64-NEXT:    lea r9, [r9 + r10]
; X64-NEXT:    mov rax, r9
; X64-NEXT:    ret
;
; ARM64-LABEL: <vr_add_v5i64>:
; ARM64:         ldr x1, [x0]
...
; ARM64-NEXT:    add x7, x7, x6
; ARM64-NEXT:    mov x8, x3
; ARM64-NEXT:    add x8, x8, x7
; ARM64-NEXT:    mov x9, x4
; ARM64-NEXT:    add x9, x9, x8
; ARM64-NEXT:    mov x10, x5
; ARM64-NEXT:    add x10, x10, x9
; ARM64-NEXT:    mov x0, x10
; ARM64-NEXT:    ret
  %v = load <5 x i64>, ptr %p
  %r = call i64 @llvm.vector.reduce.add(<5 x i64> %v)
  ret i64 %r
}
