...
define i8 @vr_or_v1i8(ptr %p) {
; X64-LABEL: <vr_or_v1i8>:
...
define i8 @vr_or_v5i8(ptr %p) {
; X64-LABEL: <vr_or_v5i8>:
; X64:         movzx eax, byte ptr [rdi]
...
; X64-NEXT:    or r9d, r10d
; X64-NEXT:    mov r11d, edx
; X64-NEXT:    or r9d, r11d
...
; ARM64-NEXT:    orr w7, w7, w6
; ARM64-NEXT:    mov w8, w3
; ARM64-NEXT:    orr w8, w8, w7
; ARM64-NEXT:    mov w9, w4
; ARM64-NEXT:    orr w9, w9, w8
; ARM64-NEXT:    mov w10, w5
; ARM64-NEXT:    orr w10, w10, w9
...
define i8 @vr_or_v8i8(ptr %p) {
; X64-LABEL: <vr_or_v8i8>:
; X64:         push rbp
...
; ARM64-NEXT:    orr w3, w3, w2
; ARM64-NEXT:    umov w4, v0.b[4]
; ARM64-NEXT:    orr w4, w4, w3
; ARM64-NEXT:    umov w5, v0.b[5]
; ARM64-NEXT:    orr w5, w5, w4
; ARM64-NEXT:    umov w6, v0.b[6]
; ARM64-NEXT:    orr w6, w6, w5
...
define i8 @vr_or_v16i8(ptr %p) {
; X64-LABEL: <vr_or_v16i8>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
...
; ARM64-NEXT:    orr w11, w11, w10
; ARM64-NEXT:    umov w12, v0.b[12]
; ARM64-NEXT:    orr w12, w12, w11
; ARM64-NEXT:    umov w13, v0.b[13]
; ARM64-NEXT:    orr w13, w13, w12
; ARM64-NEXT:    umov w14, v0.b[14]
; ARM64-NEXT:    orr w14, w14, w13
; ARM64-NEXT:    umov w15, v0.b[15]
; ARM64-NEXT:    orr w15, w15, w14
...
define i8 @vr_or_v32i8(ptr %p) {
; X64-LABEL: <vr_or_v32i8>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    movups xmm0, xmmword ptr [rdi]
...
; ARM64-NEXT:    orr w18, w18, w15
; ARM64-NEXT:    umov w30, v1.b[1]
; ARM64-NEXT:    orr w30, w30, w18
; ARM64-NEXT:    umov w0, v1.b[2]
; ARM64-NEXT:    orr w0, w0, w30
...
define i16 @vr_or_v1i16(ptr %p) {
; X64-LABEL: <vr_or_v1i16>:
...
define i16 @vr_or_v5i16(ptr %p) {
; X64-LABEL: <vr_or_v5i16>:
; X64:         movzx eax, word ptr [rdi]
...
define i16 @vr_or_v8i16(ptr %p) {
; X64-LABEL: <vr_or_v8i16>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    movups xmm0, xmmword ptr [rdi]
; X64-NEXT:    movapd xmmword ptr [rbp - 0x40], xmm0
...
define i16 @vr_or_v16i16(ptr %p) {
; X64-LABEL: <vr_or_v16i16>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    movups xmm0, xmmword ptr [rdi]
; X64-NEXT:    movups xmm1, xmmword ptr [rdi + 0x10]
...
define i32 @vr_or_v1i32(ptr %p) {
; X64-LABEL: <vr_or_v1i32>:
...
define i32 @vr_or_v4i32(ptr %p) {
; X64-LABEL: <vr_or_v4i32>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    movups xmm0, xmmword ptr [rdi]
; X64-NEXT:    movapd xmmword ptr [rbp - 0x40], xmm0
...
define i32 @vr_or_v5i32(ptr %p) {
; X64-LABEL: <vr_or_v5i32>:
; X64:         mov eax, dword ptr [rdi]
...
define i32 @vr_or_v8i32(ptr %p) {
; X64-LABEL: <vr_or_v8i32>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    movups xmm0, xmmword ptr [rdi]
; X64-NEXT:    movups xmm1, xmmword ptr [rdi + 0x10]
...
define i64 @vr_or_v1i64(ptr %p) {
; X64-LABEL: <vr_or_v1i64>:
...
define i64 @vr_or_v2i64(ptr %p) {
; X64-LABEL: <vr_or_v2i64>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    movups xmm0, xmmword ptr [rdi]
; X64-NEXT:    movapd xmmword ptr [rbp - 0x40], xmm0
...
define i64 @vr_or_v5i64(ptr %p) {
; X64-LABEL: <vr_or_v5i64>:
; X64:         mov rax, qword ptr [rdi]
...
; ARM64-NEXT:    orr x7, x7, x6
; ARM64-NEXT:    mov x8, x3
; ARM64-NEXT:    orr x8, x8, x7
; ARM64-NEXT:    mov x9, x4
; ARM64-NEXT:    orr x9, x9, x8
; ARM64-NEXT:    mov x10, x5
; ARM64-NEXT:    orr x10, x10, x9
