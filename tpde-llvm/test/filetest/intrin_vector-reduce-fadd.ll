...
define float @vr_fadd_v4f32(float %s, ptr %p) {
; X64-LABEL: <vr_fadd_v4f32>:
; X64:         push rbp
...
; ARM64-NEXT:    fadd s0, s0, s4
; ARM64-NEXT:    mov s5, v1.s[3]
; ARM64-NEXT:    fadd s0, s0, s5
; ARM64-NEXT:    ret
...
; X64-NEXT:    addss xmm0, xmm7
; X64-NEXT:    movapd xmm8, xmm3
; X64-NEXT:    addss xmm0, xmm8
; X64-NEXT:    movapd xmm9, xmm4
; X64-NEXT:    addss xmm0, xmm9
; X64-NEXT:    movapd xmm10, xmm5
; X64-NEXT:    addss xmm0, xmm10
; X64-NEXT:    ret
;
...
; ARM64-NEXT:    fadd s0, s0, s7
; ARM64-NEXT:    mov v16.16b, v3.16b
; ARM64-NEXT:    fadd s0, s0, s16
; ARM64-NEXT:    mov v17.16b, v4.16b
; ARM64-NEXT:    fadd s0, s0, s17
; ARM64-NEXT:    mov v18.16b, v5.16b
; ARM64-NEXT:    fadd s0, s0, s18
; ARM64-NEXT:    ret
...
define float @vr_fadd_v8f32(float %s, ptr %p) {
; X64-LABEL: <vr_fadd_v8f32>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    movups xmm1, xmmword ptr [rdi]
...
define double @vr_fadd_v2f64(double %s, ptr %p) {
; X64-LABEL: <vr_fadd_v2f64>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    movups xmm1, xmmword ptr [rdi]
; X64-NEXT:    movapd xmmword ptr [rbp - 0x40], xmm1
...
; X64-NEXT:    movapd xmm7, xmm2
; X64-NEXT:    addsd xmm0, xmm7
; X64-NEXT:    movapd xmm8, xmm3
; X64-NEXT:    addsd xmm0, xmm8
; X64-NEXT:    movapd xmm9, xmm4
; X64-NEXT:    addsd xmm0, xmm9
; X64-NEXT:    movapd xmm10, xmm5
; X64-NEXT:    addsd xmm0, xmm10
; X64-NEXT:    ret
;
...
; ARM64-NEXT:    mov v7.16b, v2.16b
; ARM64-NEXT:    fadd d0, d0, d7
; ARM64-NEXT:    mov v16.16b, v3.16b
; ARM64-NEXT:    fadd d0, d0, d16
; ARM64-NEXT:    mov v17.16b, v4.16b
; ARM64-NEXT:    fadd d0, d0, d17
; ARM64-NEXT:    mov v18.16b, v5.16b
; ARM64-NEXT:    fadd d0, d0, d18
; ARM64-NEXT:    ret
