...
; ARM64-NEXT:    ldr w10, [x9, #0x8]
; ARM64-NEXT:    add w0, w0, w10
; ARM64-NEXT:    ret
entry:
...
; ARM64-NEXT:    ldr x12, [x9]
; ARM64-NEXT:    str x10, [x12]
; ARM64-NEXT:    str x12, [x9, #0x8]
; ARM64-NEXT:    ldp x11, x13, [x11]
; ARM64-NEXT:    mov x0, x11
; ARM64-NEXT:    mov x1, x13
; ARM64-NEXT:    ret
  %l1 = load i64, ptr %b
  %l2 = load ptr, ptr %a
  store i64 %l1, ptr %l2
...
; X64-NEXT:    mov rcx, qword ptr [rsi]
; X64-NEXT:    mov qword ptr [rsp + 0x10], rcx
; X64-NEXT:    mov rsi, qword ptr [rdx]
; X64-NEXT:    mov qword ptr [rsp + 0x20], rsi
; X64-NEXT:    mov rsi, qword ptr [rdx + 0x8]
; X64-NEXT:    mov qword ptr [rsp + 0x28], rsi
; X64-NEXT:  <L0>:
; X64-NEXT:    call <L0>
...
; X64-NEXT:    mov ecx, dword ptr [rbp + 0x18]
; X64-NEXT:    mov dword ptr [rdi], ecx
; X64-NEXT:    movzx edx, byte ptr [rbp + 0x20]
...
; X64-NEXT:    movzx r8d, byte ptr [rdx]
; X64-NEXT:    mov byte ptr [rsp + 0x10], r8b
...
; ARM64-NEXT:    ldp x29, x30, [sp], #0x170
; ARM64-NEXT:    ret
  ret void
}
...
define void @fn_byval6(ptr byval([7 x i8]) %a) {
; X64-LABEL: <fn_byval6>:
; X64:         ret
;
; ARM64-LABEL: <fn_byval6>:
; ARM64:         mov x17, sp
; ARM64-NEXT:    add x9, x17, #0x0
; ARM64-NEXT:    ret
  ret void
...
define void @call_byval6(ptr %a) {
; X64-LABEL: <call_byval6>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    sub rsp, 0x30
...
; X64-NEXT:    ret
;
; ARM64-LABEL: <call_byval6>:
; ARM64:         stp x29, x30, [sp, #-0xa0]!
; ARM64-NEXT:    mov x29, sp
; ARM64-NEXT:    sub sp, sp, #0x10
; ARM64-NEXT:    ldr w16, [x0]
; ARM64-NEXT:    str w16, [sp]
; ARM64-NEXT:    ldrh w16, [x0, #0x4]
...
; ARM64-NEXT:    ldp x29, x30, [sp], #0xa0
; ARM64-NEXT:    ret
  call void @fn_byval6(ptr %a)
  ret void
}

define void @fn_byval7(ptr byval([3 x i8]) %a) {
; X64-LABEL: <fn_byval7>:
; X64:         ret
;
; ARM64-LABEL: <fn_byval7>:
; ARM64:         mov x17, sp
; ARM64-NEXT:    add x9, x17, #0x0
; ARM64-NEXT:    ret
  ret void
...
define void @call_byval7(ptr %a) {
; X64-LABEL: <call_byval7>:
; X64:         push rbp
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    sub rsp, 0x30
...
; X64-NEXT:    ret
;
; ARM64-LABEL: <call_byval7>:
; ARM64:         stp x29, x30, [sp, #-0xa0]!
; ARM64-NEXT:    mov x29, sp
; ARM64-NEXT:    sub sp, sp, #0x10
; ARM64-NEXT:    ldrh w16, [x0]
