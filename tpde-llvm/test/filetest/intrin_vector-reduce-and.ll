...
; X64-NEXT:    and r9d, r10d
; X64-NEXT:    mov r11d, edx
; X64-NEXT:    and r9d, r11d
; X64-NEXT:    mov edi, esi
; X64-NEXT:    and r9d, edi
...
; ARM64-NEXT:    and w7, w7, w6
; ARM64-NEXT:    mov w8, w3
; ARM64-NEXT:    and w8, w8, w7
; ARM64-NEXT:    mov w9, w4
; ARM64-NEXT:    and w9, w9, w8
; ARM64-NEXT:    mov w10, w5
; ARM64-NEXT:    and w10, w10, w9
...
; ARM64-NEXT:    and w3, w3, w2
; ARM64-NEXT:    umov w4, v0.b[4]
; ARM64-NEXT:    and w4, w4, w3
; ARM64-NEXT:    umov w5, v0.b[5]
; ARM64-NEXT:    and w5, w5, w4
; ARM64-NEXT:    umov w6, v0.b[6]
; ARM64-NEXT:    and w6, w6, w5
...
; ARM64-NEXT:    and w11, w11, w10
; ARM64-NEXT:    umov w12, v0.b[12]
; ARM64-NEXT:    and w12, w12, w11
; ARM64-NEXT:    umov w13, v0.b[13]
; ARM64-NEXT:    and w13, w13, w12
; ARM64-NEXT:    umov w14, v0.b[14]
; ARM64-NEXT:    and w14, w14, w13
; ARM64-NEXT:    umov w15, v0.b[15]
; ARM64-NEXT:    and w15, w15, w14
...
; ARM64-NEXT:    and w18, w18, w15
; ARM64-NEXT:    umov w30, v1.b[1]
; ARM64-NEXT:    and w30, w30, w18
; ARM64-NEXT:    umov w0, v1.b[2]
; ARM64-NEXT:    and w0, w0, w30
...
define i16 @vr_and_v16i16(ptr %p) {
...
; ARM64-NEXT:    and x7, x7, x6
; ARM64-NEXT:    mov x8, x3
; ARM64-NEXT:    and x8, x8, x7
; ARM64-NEXT:    mov x9, x4
; ARM64-NEXT:    and x9, x9, x8
; ARM64-NEXT:    mov x10, x5
; ARM64-NEXT:    and x10, x10, x9
