...
; ARM64:         cmeq v0.8b, v0.8b, v1.8b
; ARM64-NEXT:    ret
  %r = icmp eq <8 x i8> %a, %b
  %x = sext <8 x i1> %r to <8 x i8>
  ret <8 x i8> %x
}
...
; ARM64:         cmeq v0.16b, v0.16b, v1.16b
; ARM64-NEXT:    ret
  %r = icmp eq <16 x i8> %a, %b
  %x = sext <16 x i1> %r to <16 x i8>
  ret <16 x i8> %x
}
...
; ARM64:         cmeq v0.4h, v0.4h, v1.4h
; ARM64-NEXT:    ret
  %r = icmp eq <4 x i16> %a, %b
  %x = sext <4 x i1> %r to <4 x i16>
  ret <4 x i16> %x
}
...
; ARM64:         cmeq v0.8h, v0.8h, v1.8h
; ARM64-NEXT:    ret
  %r = icmp eq <8 x i16> %a, %b
  %x = sext <8 x i1> %r to <8 x i16>
  ret <8 x i16> %x
}
...
; ARM64:         cmeq v0.2s, v0.2s, v1.2s
; ARM64-NEXT:    ret
  %r = icmp eq <2 x i32> %a, %b
  %x = sext <2 x i1> %r to <2 x i32>
  ret <2 x i32> %x
}
...
; ARM64:         cmeq v0.4s, v0.4s, v1.4s
; ARM64-NEXT:    ret
  %r = icmp eq <4 x i32> %a, %b
  %x = sext <4 x i1> %r to <4 x i32>
  ret <4 x i32> %x
}
...
; ARM64:         cmeq v0.2d, v0.2d, v1.2d
; ARM64-NEXT:    ret
  %r = icmp eq <2 x i64> %a, %b
  %x = sext <2 x i1> %r to <2 x i64>
  ret <2 x i64> %x
}
...
; ARM64:         cmhi v0.16b, v0.16b, v1.16b
; ARM64-NEXT:    ret
...
; X64-NEXT:    pshufd {{.*#+}} xmm3 = xmm2[0,0,2,2]
; X64-NEXT:    pcmpeqd xmm0, xmm1
...
; X64-NEXT:    pshufd {{.*#+}} xmm3 = xmm1[0,0,2,2]
...
; ARM64:         cmhs v0.16b, v0.16b, v1.16b
; ARM64-NEXT:    ret
...
; X64-NEXT:    pshufd {{.*#+}} xmm1 = xmm2[1,1,3,3]
...
; ARM64:         cmhi v1.16b, v1.16b, v0.16b
; ARM64-NEXT:    mov v0.16b, v1.16b
; ARM64-NEXT:    ret
...
; ARM64:         cmhs v1.16b, v1.16b, v0.16b
; ARM64-NEXT:    mov v0.16b, v1.16b
; ARM64-NEXT:    ret
...
; ARM64:         cmgt v0.16b, v0.16b, v1.16b
; ARM64-NEXT:    ret
...
; ARM64:         cmge v0.16b, v0.16b, v1.16b
; ARM64-NEXT:    ret
...
; ARM64:         cmgt v1.16b, v1.16b, v0.16b
; ARM64-NEXT:    mov v0.16b, v1.16b
; ARM64-NEXT:    ret
...
; ARM64:         cmge v1.16b, v1.16b, v0.16b
; ARM64-NEXT:    mov v0.16b, v1.16b
; ARM64-NEXT:    ret
