...
; ARM64-NEXT:    str x3, [sp, #0x8]
; ARM64-NEXT:    str w0, [sp, #0x10]
; ARM64-NEXT:    mov x4, x2
; ARM64-NEXT:    mov x5, x3
...
; ARM64-NEXT:    sub sp, sp, #0x20
; ARM64-NEXT:    str w0, [sp]
; ARM64-NEXT:    str x2, [sp, #0x10]
; ARM64-NEXT:    str x3, [sp, #0x18]
; ARM64-NEXT:    mov x0, x2
; ARM64-NEXT:    mov x1, x3
; ARM64-NEXT:    mov x4, x2
; ARM64-NEXT:    mov x5, x3
...
; ARM64-NEXT:    sub sp, sp, #0x20
; ARM64-NEXT:    mov w0, #0x0 // =0
; ARM64-NEXT:    str x0, [sp]
; ARM64-NEXT:    mov w0, #0x0 // =0
; ARM64-NEXT:    str x0, [sp, #0x8]
; ARM64-NEXT:    mov w0, #0x0 // =0
; ARM64-NEXT:    str x0, [sp, #0x10]
; ARM64-NEXT:    mov w0, #0x0 // =0
; ARM64-NEXT:    str x0, [sp, #0x18]
; ARM64-NEXT:    mov w0, #0x0 // =0
...
; ARM64-NEXT:    ubfx x0, x0, #0, #1
; ARM64-NEXT:    sub sp, sp, #0x20
; ARM64-NEXT:    strb w0, [sp]
; ARM64-NEXT:    sbfx x1, x1, #0, #1
; ARM64-NEXT:    strb w1, [sp, #0x8]
; ARM64-NEXT:    ubfx x2, x2, #0, #37
; ARM64-NEXT:    str x2, [sp, #0x10]
; ARM64-NEXT:    sbfx x3, x3, #0, #37
; ARM64-NEXT:    str x3, [sp, #0x18]
...
; X64-NEXT:    mov qword ptr [rsp + 0x8], rax
; X64-NEXT:    xor edi, edi
; X64-NEXT:    mov qword ptr [rsp + 0x10], rdi
; X64-NEXT:    mov rdi, rsi
...
; X64-NEXT:    xor edi, edi
; X64-NEXT:    mov word ptr [rsp + 0x10], di
; X64-NEXT:    mov edi, esi
; X64-NEXT:    mov esi, edx
; X64-NEXT:    mov edx, ecx
; X64-NEXT:    mov ecx, r8d
...
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    sub rsp, 0x40
; X64-NEXT:    movd xmm0, dword ptr [rbp + 0x18]
; X64-NEXT:    movss dword ptr [rsp], xmm0
; X64-NEXT:    movd xmm0, dword ptr [rbp + 0x20]
; X64-NEXT:    movss dword ptr [rsp + 0x8], xmm0
; X64-NEXT:    pxor xmm8, xmm8
; X64-NEXT:    movss dword ptr [rsp + 0x10], xmm8
...
; X64-NEXT:    mov rbp, rsp
; X64-NEXT:    sub rsp, 0x40
; X64-NEXT:    movq xmm0, qword ptr [rbp + 0x18]
; X64-NEXT:    movsd qword ptr [rsp], xmm0
; X64-NEXT:    movq xmm0, qword ptr [rbp + 0x20]
; X64-NEXT:    movsd qword ptr [rsp + 0x8], xmm0
; X64-NEXT:    pxor xmm8, xmm8
; X64-NEXT:    movsd qword ptr [rsp + 0x10], xmm8
; X64-NEXT:    movapd xmm0, xmm1
; X64-NEXT:    movapd xmm1, xmm2
; X64-NEXT:    movapd xmm2, xmm3
; X64-NEXT:    movapd xmm3, xmm4
...
; X64-NEXT:    movss dword ptr [rsp + 0x8], xmm1
; X64-NEXT:    pxor xmm1, xmm1
; X64-NEXT:    movsd qword ptr [rsp + 0x10], xmm1
