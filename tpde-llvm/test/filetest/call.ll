...
; X64-NEXT:    mov qword ptr [rsp + 0x10], r10
; X64-NEXT:  <L0>:
; X64-NEXT:    call <L0>
...
; X64-NEXT:    mov word ptr [rsp + 0x8], ax
; X64-NEXT:    xor r10d, r10d
; X64-NEXT:    mov word ptr [rsp + 0x10], r10w
; X64-NEXT:  <L0>:
; X64-NEXT:    call <L0>
...
; X64-NEXT:    mov byte ptr [rsp + 0x8], al
; X64-NEXT:    xor r10d, r10d
; X64-NEXT:    mov byte ptr [rsp + 0x10], r10b
; X64-NEXT:  <L0>:
; X64-NEXT:    call <L0>
