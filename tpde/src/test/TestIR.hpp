...
namespace tpde::test {
    ...
    struct TestIRAdaptor {
        ...
        [[nodiscard]] bool inst_has_call(IRInstRef inst) const noexcept {
            return ir->values[static_cast<u32>(inst)].op == TestIR::Value::Op::call;
        }
